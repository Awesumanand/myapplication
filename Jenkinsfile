node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u anand629 -p osm_anand1" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag d64d03c9899d  anand629/myapplication" //must change your name and tag no
        sh "docker push   anand629/myapplication"
  }
}
